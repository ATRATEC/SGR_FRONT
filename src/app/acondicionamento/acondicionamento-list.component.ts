 ...
 */
  validaSelecao(): boolean {
    if (this.selectedRowIndex === -1) {
      ...
      return true;
      // alert('Acondicionamento para selecionado para exclusão ' + this.selectedRow.codigo_acondicionamento);
      // this.ngOnInit();
      // this.selectedRowIndex = -1;
      // this.selectedRow = null;
    }
  ...
  editarRegistro() {
    if (this.validaSelecao()) {
      ...
      // alert('Acondicionamento para selecionado para edição ' + this.selectedRow.codigo_acondicionamento);
      this.ngOnInit();
      this.selectedRowIndex = -1;
      this.selectedRow = null;
    }
